# -*- coding: UTF-8 -*-
"""
Defines the fields that can be added to redjango models.
"""
import time
    ...
    def __get__(self, instance, owner):
        ...
        try:
            ...
            if not instance.is_new():
                using = router.db_for_read(owner, instance=instance)
                connection = connections[using]
                val = connection.hget(instance.key(), self.name)
                if val is not None:
...
class ListField(object):
    ...
    ListField also accepts a string that refers to a redjango model.
    ...
    def __init__(self, target_type,
        ...
        self._redjango_model = (isinstance(target_type, basestring) or
